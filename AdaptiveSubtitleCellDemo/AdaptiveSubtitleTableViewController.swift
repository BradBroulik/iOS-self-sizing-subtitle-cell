...
final class AdaptiveSubtitleTableViewController : UITableViewController {
    ...
    private enum Cell: String {
        ...
        func identifier() -> String {
            switch self {
            case .subtitleCell: return SubtitleCell.identifier
            }
        }
    }
    ...
    override func viewDidLoad() {
        ...
        title = "Adaptive Subtitle Cell Examples"
        tableView.estimatedRowHeight = 80
        tableView.rowHeight = UITableViewAutomaticDimension
        tableView.register(UINib(nibName: String(describing: SubtitleCell.self), bundle: nil), forCellReuseIdentifier: SubtitleCell.identifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch row.cell {
        case .subtitleCell:
            let subtitleCell = cell as! SubtitleCell
